...
class Field extends Products\Field\Field
{
     ...
     * @throws QUI\Exception
     */
    public function removeTags(string $lang, null | string $generator = null): bool
    {
        $tags = $this->getTags();
     ...
     */
    public function getTags(null | string $generator = null): array
    {
        $val = $this->getValue();
     ...
     */
    public function getTagList(null | string $generator = null): array
    {
        $val = $this->getValue();
